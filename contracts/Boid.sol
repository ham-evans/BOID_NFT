...
contract Boid is ERC721URIStorage, Ownable {
    using SafeMath for uint256;

    string public BOID_IFPS = ""; //IFPS link for reveal 

    uint256 public constant MAX_BOIDS = 1000;
    ...
    mapping (address => uint) public ownerBoidCount;
    ...
    function mintBoid (uint numberOfTokens) public {
